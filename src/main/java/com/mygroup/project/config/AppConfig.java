...
@ComponentScans(value = { @ComponentScan("com.mygroup.project.dao"),
        @ComponentScan("com.mygroup.project.service") })
public class AppConfig {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setPackagesToScan("com.mygroup.project.model");
